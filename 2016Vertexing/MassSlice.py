...
import getopt
import ROOT
from ROOT import gROOT, TCanvas, TF1, TFile, gStyle, TFormula, TGraph, TGraphErrors, TLegend, TH1D, TCutG, TH2D, gDirectory, RooDataSet, RooRealVar, RooArgSet, RooFormulaVar, RooWorkspace, RooAbsData, RooGlobalFunc, RooFit, RooAbsReal, RooArgList, gPad, TLatex, TH1F, TLine
...
h1d.SetTitle("Mass Slice {0:0.0f} MeV #pm {1:0.1f} MeV {2}".format(mass*1000,(masscut_nsigma/2*mres)*1000,label))
fit=h1d.Fit("gaus","QS")
...
h1d.SetMarkerColor(4)
h1d.GetYaxis().SetRangeUser(10e-5,10e5)
hnewap.SetLineColor(1)
hnewap.SetMarkerStyle(2)
hnewap.SetMarkerColor(1)
