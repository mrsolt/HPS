...
if(useZcut):
	if(L1L2):
		if(useData):
			...
			cuts.append("(uncVZ>{0}+{1}*uncM+{2}*zcutL1L1 = "{0}+{1}*uncM+{2}*uncM^2+{3}*uncM^3+{4}*uncM^4+{5}*uncM^5".format(-0.4738,1551,-3.835e4,3.930e5,-1.865e6,3.373e6) #100% Data L1L1uncM^2+{3}*uncM^3+{4}*uncM^4+{5}*uncM^5)".format(-164.9,1.012e4,-2.087e5,2.039e6,-9.614e6,1.761e7))
		else:
		...
		if(useData):
			...
			zcut = TF1("zcut","{0}+{1}*uncM+{2}*uncM^2+{3}*uncM^3+{4}*uncM^4+{5}*uncM^5".format(-0.4738,1551,-3.835e4,3.930e5,-1.865e6,3.373e6),0.05,0.175) #100% Data L1L1
