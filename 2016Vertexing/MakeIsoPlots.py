...
ap1events.Draw("uncVZ:{0}>>eleiso_ap1(100,-3,7,100,-40,80)".format(eleiso))
ap1events.Draw("uncVZ:{0}>>posiso_ap1(100,-3,7,100,-40,80)".format(posiso))
ap1events.Draw("uncVZ>>uncVZ_ap1(100,-40,80)")
ap1events.Draw("uncVZ>>uncVZ_ap1_isocut(100,-40,80)",eleiso+">0&&"+posiso+">0")
#ap1events.Draw("uncVZ>>uncVZ_ap1_truth(100,-40,80)",truthCutele+"||"+truthCutpos)
#ap1events.Draw("uncVZ>>uncVZ_ap1(100,-40,80)",purityCut)

ap2events.Draw("uncVZ:{0}>>eleiso_ap2(100,-3,7,100,-40,80)".format(eleiso))
ap2events.Draw("uncVZ:{0}>>posiso_ap2(100,-3,7,100,-40,80)".format(posiso))
ap2events.Draw("uncVZ>>uncVZ_ap2(100,-40,80)")
ap2events.Draw("uncVZ>>uncVZ_ap2_isocut(100,-40,80)",eleiso+">0&&"+posiso+">0")
#ap2events.Draw("uncVZ>>uncVZ_ap2_truth(100,-40,80)",truthCutele+"||"+truthCutpos)
#ap2events.Draw("uncVZ>>uncVZ_ap2(100,-40,80)",purityCut)
