...
plots.append("eleClT-eleTrkT-{0} -10 10".format(clusterT))
plots.append("posClT-posTrkT-{0} -10 10".format(clusterT))
...
plots.append("eleTrkD0 -4 4")
plots.append("posTrkD0 -4 4")
...
cuts.append("elePurity>0.99&&posPurity<0.99")
cuts.append("elePurity<0.99&&posPurity>0.99")
cuts.append("(elePurity<0.99||posPurity<0.99)&&(eleHasL1&&!posHasL1)")
cuts.append("(elePurity>0.99&&posPurity<0.99)&&(eleHasL1&&!posHasL1)")
cuts.append("(elePurity<0.99&&posPurity>0.99)&&(eleHasL1&&!posHasL1)")
cuts.append("(elePurity<0.99||posPurity<0.99)&&(!eleHasL1&&posHasL1)")
cuts.append("(elePurity>0.99&&posPurity<0.99)&&(!eleHasL1&&posHasL1)")
