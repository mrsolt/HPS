...
plots.append("uncVZ eleTrkZ0 {0} {1} -5 5".format(minVZ,maxVZ))
plots.append("uncVZ posTrkZ0 {0} {1} -5 5".format(minVZ,maxVZ))
plots.append("uncVZ eleTrkD0 {0} {1} -5 5".format(minVZ,maxVZ))
plots.append("uncVZ posTrkD0 {0} {1} -5 5".format(minVZ,maxVZ))
plots.append("uncVZ uncVX-(uncVZ)*uncPX/uncPZ {0} {1} -1 1".format(minVZ,maxVZ))
plots.append("uncVZ uncVY-(uncVZ)*uncPY/uncPZ {0} {1} -1 1".format(minVZ,maxVZ))
