...
cuts.append("(pow((uncVX-(uncVZ-0.5)*uncPX/uncPZ-0.1)*cos(-0.5)-(uncVY-(uncVZ-0.5)*uncPY/uncPZ)*sin(-0.5),2)/0.4356+pow((uncVX-(uncVZ-0.5)*uncPX/uncPZ)*sin(-0.5)+(uncVY-(uncVZ-0.5)*uncPY/uncPZ)*cos(-0.5),2)/0.3249)<1 1 0")
...
cuts.append("(pow((uncVX-(uncVZ-0.5)*uncPX/uncPZ-0.1)*cos(-0.5)-(uncVY-(uncVZ-0.5)*uncPY/uncPZ)*sin(-0.5),2)/0.4356+pow((uncVX-(uncVZ-0.5)*uncPX/uncPZ)*sin(-0.5)+(uncVY-(uncVZ-0.5)*uncPY/uncPZ)*cos(-0.5),2)/0.3249)<0.55 1 0")
