...
plots2D.append("(-triEle1PX/triEle1PZ*triEndZ+triEndX-eleTrkD0)/eleTrkD0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(-triPosPX/triPosPZ*triEndZ+triEndX-posTrkD0)/posTrkD0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
applots.append("(-triEle1PX/triEle1PZ*triEndZ+triEndX-eleTrkD0)/eleTrkD0Err -5 5")
applots.append("(-triPosPX/triPosPZ*triEndZ+triEndX-posTrkD0)/posTrkD0Err -5 5")
...
applots2D.append("(-triEle1PX/triEle1PZ*triEndZ+triEndX-eleTrkD0)/eleTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(-triPosPX/triPosPZ*triEndZ+triEndX-posTrkD0)/posTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
fitplots.append("(-triEle1PX/triEle1PZ*triEndZ+triEndX-eleTrkD0)/eleTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(-triPosPX/triPosPZ*triEndZ+triEndX-posTrkD0)/posTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
