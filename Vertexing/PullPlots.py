...
plots.append("(triEle1PX/triEle1PZ+0.0305-eleTrkPhi)/eleTrkPhiErr -5 5")
plots.append("(triPosPX/triPosPZ+0.0305-posTrkPhi)/posTrkPhiErr -5 5")
plots.append("(0.000193/sqrt(triEle1PX**2+triEle1PZ**2)-eleTrkOmega)/eleTrkOmegaErr -5 5")
plots.append("(0.000193/sqrt(triPosPX**2+triPosPZ**2)-posTrkOmega)/posTrkOmegaErr -5 5")
...
plots2D.append("(triEle1PY/triEle1PZ*triEndZ-eleTrkZ0)/eleTrkZ0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(triPosPY/triPosPZ*triEndZ-posTrkZ0)/posTrkZ0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(triEle1PX/triEle1PZ*triEndZ-eleTrkD0)/eleTrkD0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(triPosPX/triPosPZ*triEndZ-posTrkD0)/posTrkD0Err uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
plots2D.append("(triEle1PX/triEle1PZ+0.0305-eleTrkPhi)/eleTrkPhiErr uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(triPosPX/triPosPZ+0.0305-posTrkPhi)/posTrkPhiErr uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(0.000193/sqrt(triEle1PX**2+triEle1PZ**2)-eleTrkOmega)/eleTrkOmegaErr uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))
plots2D.append("(0.000193/sqrt(triPosPX**2+triPosPZ**2)-posTrkOmega)/posTrkOmegaErr uncVZ -5 5 {0} {1}".format(minVZ,maxVZ))


applots = []
applots.append("(uncVZ-{0})/sqrt(uncCovZZ) -5 50".format(zTarg))
applots.append("(uncVZ-triEndZ)/sqrt(uncCovZZ) -5 5")
applots.append("(triEle1PY/triEle1PZ*triEndZ-eleTrkZ0)/eleTrkZ0Err -5 5")
applots.append("(triPosPY/triPosPZ*triEndZ-posTrkZ0)/posTrkZ0Err -5 5")
applots.append("(triEle1PX/triEle1PZ*triEndZ-eleTrkD0)/eleTrkD0Err -5 5")
applots.append("(triPosPX/triPosPZ*triEndZ-posTrkD0)/posTrkD0Err -5 5")
...
applots.append("(triEle1PX/triEle1PZ+0.0305-eleTrkPhi)/eleTrkPhiErr -5 5")
applots.append("(triPosPX/triPosPZ+0.0305-posTrkPhi)/posTrkPhiErr -5 5")
applots.append("(0.000193/sqrt(triEle1PX**2+triEle1PZ**2)-eleTrkOmega)/eleTrkOmegaErr -5 5")
applots.append("(0.000193/sqrt(triPosPX**2+triPosPZ**2)-posTrkOmega)/posTrkOmegaErr -5 5")
...
applots2D.append("(triEle1PY/triEle1PZ*triEndZ-eleTrkZ0)/eleTrkZ0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(triPosPY/triPosPZ*triEndZ-posTrkZ0)/posTrkZ0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(triEle1PX/triEle1PZ*triEndZ-eleTrkD0)/eleTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(triPosPX/triPosPZ*triEndZ-posTrkD0)/posTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
applots2D.append("(triEle1PX/triEle1PZ+0.0305-eleTrkPhi)/eleTrkPhiErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(triPosPX/triPosPZ+0.0305-posTrkPhi)/posTrkPhiErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(0.000193/sqrt(triEle1PX**2+triEle1PZ**2)-eleTrkOmega)/eleTrkOmegaErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(0.000193/sqrt(triPosPX**2+triPosPZ**2)-posTrkOmega)/posTrkOmegaErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
fitplots.append("(triEle1PY/triEle1PZ*triEndZ-eleTrkZ0)/eleTrkZ0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(triPosPY/triPosPZ*triEndZ-posTrkZ0)/posTrkZ0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(triEle1PX/triEle1PZ*triEndZ-eleTrkD0)/eleTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(triPosPX/triPosPZ*triEndZ-posTrkD0)/posTrkD0Err triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
fitplots.append("(triEle1PX/triEle1PZ+0.0305-eleTrkPhi)/eleTrkPhiErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(triPosPX/triPosPZ+0.0305-posTrkPhi)/posTrkPhiErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(0.000193/sqrt(triEle1PX**2+triEle1PZ**2)-eleTrkOmega)/eleTrkOmegaErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(0.000193/sqrt(triPosPX**2+triPosPZ**2)-posTrkOmega)/posTrkOmegaErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
