...
applots.append("(uncVZ-triEndX)/sqrt(uncCovXX) -5 5")
applots.append("(uncVZ-triEndY)/sqrt(uncCovYY) -5 5")
applots.append("(uncM-triM)/uncMErr -5 5")
applots.append("(uncP-triP)/uncMomErr -5 5")
applots.append("(uncP-triPX)/uncMomXErr -5 5")
applots.append("(uncP-triPY)/uncMomYErr -5 5")
applots.append("(uncP-triPZ)/uncMomZErr -5 5")
...
applots2D.append("(uncVZ-triEndX)/sqrt(uncCovXX) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
applots2D.append("(uncVZ-triEndY)/sqrt(uncCovYY) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
...
applots2D.append("(uncP-triPX)/uncMomXErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
applots2D.append("(uncP-triPY)/uncMomYErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
applots2D.append("(uncP-triPZ)/uncMomZErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
...
fitplots.append("(uncVZ-triEndX)/sqrt(uncCovXX) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
fitplots.append("(uncVZ-triEndY)/sqrt(uncCovYY) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
...
fitplots.append("(uncP-triPX)/uncMomXErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
fitplots.append("(uncP-triPY)/uncMomYErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
fitplots.append("(uncP-triPZ)/uncMomZErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ)
