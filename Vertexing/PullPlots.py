...
applots2D.append("uncTargProjX/(uncTargProjX/(sqrt(uncCovXX)+(sqrt(uncCovZZ)*uncPX/uncPZ)+(uncVZ-0.5)*(uncMomXErr/uncPZ+uncPX*(0.000075*(eleTrkOmegaErr/eleTrkOmega^2+posTrkOmegaErr/posTrkOmega^2))/uncPZ^2))) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("uncTargProjY/(uncTargProjY/(sqrt(uncCovYY)+(sqrt(uncCovZZ)*uncPY/uncPZ)+(uncVZ-0.5)*(uncMomYErr/uncPZ+uncPY*(0.000075*(eleTrkOmegaErr/eleTrkOmega^2+posTrkOmegaErr/posTrkOmega^2))/uncPZ^2))) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
fitplots.append("uncTargProjX/(uncTargProjX/(sqrt(uncCovXX)+(sqrt(uncCovZZ)*uncPX/uncPZ)+(uncVZ-0.5)*(uncMomXErr/uncPZ+uncPX*(0.000075*(eleTrkOmegaErr/eleTrkOmega^2+posTrkOmegaErr/posTrkOmega^2))/uncPZ^2))) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("uncTargProjY/(uncTargProjY/(sqrt(uncCovYY)+(sqrt(uncCovZZ)*uncPY/uncPZ)+(uncVZ-0.5)*(uncMomYErr/uncPZ+uncPY*(0.000075*(eleTrkOmegaErr/eleTrkOmega^2+posTrkOmegaErr/posTrkOmega^2))/uncPZ^2))) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
