...
applots.append("(bscVZ-triEndZ)/sqrt(bscCovZZ) -5 5")
applots.append("(bscVX-triEndX)/sqrt(bscCovXX) -5 5")
applots.append("(bscVY-triEndY)/sqrt(bscCovYY) -5 5")
applots.append("(bscM-triM)/bscMErr -5 5")
...
applots2D.append("(bscVZ-triEndZ)/sqrt(bscCovZZ) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(bscVX-triEndX)/sqrt(bscCovXX) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(bscVY-triEndY)/sqrt(bscCovYY) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
applots2D.append("(bscM-triM)/bscMErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
...
fitplots.append("(bscVZ-triEndZ)/sqrt(bscCovZZ) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(bscVX-triEndX)/sqrt(bscCovXX) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(bscVY-triEndY)/sqrt(bscCovYY) triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
fitplots.append("(bscM-triM)/bscMErr triEndZ -5 5 {0} {1}".format(minVZ,maxVZ))
