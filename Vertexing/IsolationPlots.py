...
plots.append("eleIsoAxial uncVZ -10 10 {0} {1} eleL1tIsGoodTruthHit>-9998&&eleL1tIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("eleL1tsvthitY uncVZ {2} {3} {0} {1} eleL1tIsGoodTruthHit>-9998&&eleL1tIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("eleIsoAxial eleL1tsvthitY -10 10 {0} {1} eleL1tIsGoodTruthHit>-9998&&eleL1tIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("eleIsoStereo uncVZ -10 10 {0} {1} eleL2tIsGoodTruthHit>-9998&&eleL2tIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("eleL2tsvthitY uncVZ {2} {3} {0} {1} eleL2tIsGoodTruthHit>-9998&&eleL2tIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("eleIsoStereo eleL2tsvthitY -10 10 {0} {1} eleL2tIsGoodTruthHit>-9998&&eleL2tIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("eleIsoStereo uncVZ -10 10 {0} {1} eleL1bIsGoodTruthHit>-9998&&eleL1bIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("eleL1bsvthitY uncVZ {2} {3} {0} {1} eleL1bIsGoodTruthHit>-9998&&eleL1bIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("eleIsoStereo eleL1bsvthitY -10 10 {0} {1} eleL1bIsGoodTruthHit>-9998&&eleL1bIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("eleIsoAxial uncVZ -10 10 {0} {1} eleL2bIsGoodTruthHit>-9998&&eleL2bIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("eleL2bsvthitY uncVZ {2} {3} {0} {1} eleL2bIsGoodTruthHit>-9998&&eleL2bIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("eleIsoAxial eleL2bsvthitY -10 10 {0} {1} eleL2bIsGoodTruthHit>-9998&&eleL2bIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("posIsoAxial uncVZ -10 10 {0} {1} posL1tIsGoodTruthHit>-9998&&posL1tIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("posL1tsvthitY uncVZ {2} {3} {0} {1} posL1tIsGoodTruthHit>-9998&&posL1tIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("posIsoAxial posL1tsvthitY -10 10 {0} {1} posL1tIsGoodTruthHit>-9998&&posL1tIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("posIsoStereo uncVZ -10 10 {0} {1} posL2tIsGoodTruthHit>-9998&&posL2tIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("posL2tsvthitY uncVZ {2} {3} {0} {1} posL2tIsGoodTruthHit>-9998&&posL2tIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("posIsoStereo posL2tsvthitY -10 10 {0} {1} posL2tIsGoodTruthHit>-9998&&posL2tIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("posIsoStereo uncVZ -10 10 {0} {1} posL1bIsGoodTruthHit>-9998&&posL1bIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("posL1bsvthitY uncVZ {2} {3} {0} {1} posL1bIsGoodTruthHit>-9998&&posL1bIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("posIsoStereo posL1bsvthitY -10 10 {0} {1} posL1bIsGoodTruthHit>-9998&&posL1bIsGoodTruthHit<1".format(miny,maxy))
...
plots.append("posIsoAxial uncVZ -10 10 {0} {1} posL2bIsGoodTruthHit>-9998&&posL2bIsGoodTruthHit<1".format(minVZ,maxVZ))
plots.append("posL2bsvthitY uncVZ {2} {3} {0} {1} posL2bIsGoodTruthHit>-9998&&posL2bIsGoodTruthHit<1".format(minVZ,maxVZ,miny,maxy))
plots.append("posIsoAxial posL2bsvthitY -10 10 {0} {1} posL2bIsGoodTruthHit>-9998&&posL2bIsGoodTruthHit<1".format(miny,maxy))
