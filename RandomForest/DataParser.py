...
def main():
    ...
    background = DataParser(os.path.join(cwd, 'datasets', 'tritrig-wab-beam_100MeV_L1L1_tight.csv'))
    signal     = DataParser(os.path.join(cwd, 'datasets', 'ap_100MeV_L1L1_tight_08mm.csv'))
